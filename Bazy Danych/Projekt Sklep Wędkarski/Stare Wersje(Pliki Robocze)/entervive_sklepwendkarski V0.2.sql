...
--
-- Host: localhost
-- Generation Time: Feb 17, 2024 at 09:11 PM
...
CREATE TABLE `klient` (
  ...
  `rekorodowy_gatunekryby` varchar(255) NOT NULL,
...
(15, 'Śląskie'),
(16, 'Małopolskie'),
(17, 'Zachodnio-Pomorskie'),
(18, 'Pomorskie'),
(19, 'Warmińsko-Mazurskie'),
(20, 'Podlaskie'),
(21, 'Lubuskie'),
(22, 'Wielkopolskie'),
(23, 'Kujawsko-Pomorskie'),
(24, 'Mazowieckie'),
(25, 'Lubelskie'),
(26, 'Dolnośląskie'),
(27, 'Łódzkie'),
...
--
ALTER TABLE `towar`
  ADD CONSTRAINT `towar_ibfk_1` FOREIGN KEY (`id_kategori`) REFERENCES `kategoria_towaru` (`id_kategori`),
  ADD CONSTRAINT `towar_ibfk_2` FOREIGN KEY (`id_producenta`) REFERENCES `producent` (`id_producenta`);
