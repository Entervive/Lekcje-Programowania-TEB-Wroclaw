...
function dodaj() {
    ...
    notka.addEventListener('animationend', () => {
...
function del(event) {
    ...
    notatka.classList.add('animate__animated', 'animate__fadeOutRight', 'animate__faster');
...
function zrob(event) {
    ...
    notatka.classList.remove('animate__animated', 'animate__bounce', 'animate__bounceIn', 'animate__faster');
    ...
    if (notatka.classList.contains('done')) {
        ...
        setTimeout(() => {
            notatka.classList.add('animate__animated', 'animate__bounceIn', 'animate__faster');
        }, 10);
    } else {
        ...
        setTimeout(() => {
            notatka.classList.add('animate__animated', 'animate__bounce', 'animate__faster');
        }, 10);
    }

    notatka.addEventListener('animationend', () => {
        notatka.classList.remove('animate__animated', 'animate__bounce', 'animate__bounceIn', 'animate__faster');
    }, { once: true });
